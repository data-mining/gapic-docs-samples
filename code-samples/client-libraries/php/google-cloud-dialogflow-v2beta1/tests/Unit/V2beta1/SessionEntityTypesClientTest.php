...
use Google\Cloud\Dialogflow\V2beta1\SessionEntityTypesClient;
...
class SessionEntityTypesClientTest extends GeneratedTest
{
    ...
    public function listSessionEntityTypesTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.SessionEntityTypes/ListSessionEntityTypes', $actualFuncCall);
    ...
    public function getSessionEntityTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.SessionEntityTypes/GetSessionEntityType', $actualFuncCall);
    ...
    public function createSessionEntityTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.SessionEntityTypes/CreateSessionEntityType', $actualFuncCall);
    ...
    public function updateSessionEntityTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.SessionEntityTypes/UpdateSessionEntityType', $actualFuncCall);
    ...
    public function deleteSessionEntityTypeTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.SessionEntityTypes/DeleteSessionEntityType', $actualFuncCall);
