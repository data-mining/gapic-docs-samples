...
use Google\Cloud\Dialogflow\V2beta1\SessionsClient;
...
class SessionsClientTest extends GeneratedTest
{
    ...
    public function detectIntentTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Sessions/DetectIntent', $actualFuncCall);
    ...
    public function streamingDetectIntentTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Sessions/StreamingDetectIntent', $streamFuncCall);
