...
_COMPLETEQUERYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.talent.v4beta1.CompleteQueryRequest.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='company_name', full_name='google.cloud.talent.v4beta1.CompleteQueryRequest.company_name', index=4,
...
_COMPLETEQUERYRESPONSE.fields_by_name['metadata'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._RESPONSEMETADATA
...
CompleteQueryRequest = _reflection.GeneratedProtocolMessageType('CompleteQueryRequest', (_message.Message,), dict(
  ...
  Attributes:
      ...
      scope:
          ...
          quest.CompletionScope.PUBLIC].
      type:
          Optional.  The completion topic. The default is [CompletionTyp
          e.COMBINED][google.cloud.talent.v4beta1.CompleteQueryRequest.C
          ompletionType.COMBINED].
  """,
...
CompleteQueryResponse = _reflection.GeneratedProtocolMessageType('CompleteQueryResponse', (_message.Message,), dict(

  CompletionResult = _reflection.GeneratedProtocolMessageType('CompletionResult', (_message.Message,), dict(
...
_COMPLETION = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002%\022#/v4beta1/{name=projects/*}:complete'),
  ),
])
