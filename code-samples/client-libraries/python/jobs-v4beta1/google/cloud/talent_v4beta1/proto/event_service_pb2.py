...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_event__pb2.DESCRIPTOR,])
...
_CREATECLIENTEVENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.talent.v4beta1.CreateClientEventRequest.parent', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='client_event', full_name='google.cloud.talent.v4beta1.CreateClientEventRequest.client_event', index=1,
...
_CREATECLIENTEVENTREQUEST.fields_by_name['client_event'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_event__pb2._CLIENTEVENT
DESCRIPTOR.message_types_by_name['CreateClientEventRequest'] = _CREATECLIENTEVENTREQUEST
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CreateClientEventRequest = _reflection.GeneratedProtocolMessageType('CreateClientEventRequest', (_message.Message,), dict(
...
_EVENTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002.\")/v4beta1/{parent=projects/*}/clientEvents:\001*'),
  ),
])
