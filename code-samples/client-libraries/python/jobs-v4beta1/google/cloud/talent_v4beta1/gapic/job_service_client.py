...
class JobServiceClient(object):
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=job_service_grpc_transport.
    ...
    def update_job(self,
        ...
        request = job_service_pb2.UpdateJobRequest(
            job=job,
    ...
    def batch_delete_jobs(self,
        ...
        if 'batch_delete_jobs' not in self._inner_api_calls:
            self._inner_api_calls[
                'batch_delete_jobs'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.batch_delete_jobs,
                    default_retry=self._method_configs['BatchDeleteJobs'].
                    retry,
                    default_timeout=self._method_configs['BatchDeleteJobs'].
                    timeout,
                    client_info=self._client_info,
                )

        request = job_service_pb2.BatchDeleteJobsRequest(
            parent=parent,
            filter=filter_,
        )
    ...
    def search_jobs(self,
        ...
        if 'search_jobs' not in self._inner_api_calls:
            self._inner_api_calls[
                'search_jobs'] = google.api_core.gapic_v1.method.wrap_method(
    ...
    def search_jobs_for_alert(self,
        ...
        if 'search_jobs_for_alert' not in self._inner_api_calls:
            self._inner_api_calls[
                'search_jobs_for_alert'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.search_jobs_for_alert,
                    default_retry=self._method_configs['SearchJobsForAlert'].
                    retry,
                    default_timeout=self._method_configs['SearchJobsForAlert'].
                    timeout,
                    client_info=self._client_info,
                )
