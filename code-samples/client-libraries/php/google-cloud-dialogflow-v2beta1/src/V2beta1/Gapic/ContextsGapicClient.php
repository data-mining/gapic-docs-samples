...
class ContextsGapicClient
{
    ...
    private static $environmentContextNameTemplate;
    ...
    private static function getEnvironmentContextNameTemplate()
    {
        if (null == self::$environmentContextNameTemplate) {
            self::$environmentContextNameTemplate = new PathTemplate('projects/{project}/agent/environments/{environment}/users/{user}/sessions/{session}/contexts/{context}');
        }

        return self::$environmentContextNameTemplate;
    }
    ...
    private static function getPathTemplateMap()
    {
        if (null == self::$pathTemplateMap) {
            self::$pathTemplateMap = [
                ...
                'environmentContext' => self::getEnvironmentContextNameTemplate(),
            ];
        }
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a environment_context resource.
     *
     * @param string $project
     * @param string $environment
     * @param string $user
     ...
     * @param string $context
     *
     * @return string The formatted environment_context resource.
     * @experimental
     */
    public static function environmentContextName($project, $environment, $user, $session, $context)
    {
        return self::getEnvironmentContextNameTemplate()->render([
            'project' => $project,
            'environment' => $environment,
            'user' => $user,
            'session' => $session,
     ...
     * - environmentContext: projects/{project}/agent/environments/{environment}/users/{user}/sessions/{session}/contexts/{context}.
     *
