...
use Google\Cloud\Dialogflow\V2beta1\RestoreAgentRequest;
use Google\Cloud\Dialogflow\V2beta1\SearchAgentsRequest;
use Google\Cloud\Dialogflow\V2beta1\SearchAgentsResponse;
use Google\Cloud\Dialogflow\V2beta1\TrainAgentRequest;
...
class AgentsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.v2beta1.Agents';
