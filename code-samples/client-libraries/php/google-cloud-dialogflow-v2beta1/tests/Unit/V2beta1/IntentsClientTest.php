...
use Google\Cloud\Dialogflow\V2beta1\IntentsClient;
...
class IntentsClientTest extends GeneratedTest
{
    ...
    public function listIntentsTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Intents/ListIntents', $actualFuncCall);
    ...
    public function getIntentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Intents/GetIntent', $actualFuncCall);
    ...
    public function createIntentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Intents/CreateIntent', $actualFuncCall);
    ...
    public function updateIntentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Intents/UpdateIntent', $actualFuncCall);
    ...
    public function deleteIntentTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Intents/DeleteIntent', $actualFuncCall);
    ...
    public function batchUpdateIntentsTest()
    {
        ...
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Intents/BatchUpdateIntents', $actualApiFuncCall);
    ...
    public function batchDeleteIntentsTest()
    {
        ...
        $actualApiFuncCall = $apiRequests[0]->getFuncCall();
        $actualApiRequestObject = $apiRequests[0]->getRequestObject();
        $this->assertSame('/google.cloud.dialogflow.v2beta1.Intents/BatchDeleteIntents', $actualApiFuncCall);
        $actualValue = $actualApiRequestObject->getParent();
