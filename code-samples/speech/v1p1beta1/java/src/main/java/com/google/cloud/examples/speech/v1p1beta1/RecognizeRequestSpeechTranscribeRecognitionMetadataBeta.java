 ...
 * import java.nio.file.Paths;
 */
public class RecognizeRequestSpeechTranscribeRecognitionMetadataBeta {
  public static void sampleRecognize(String localFilePath, String languageCode) {
    ...
    try (SpeechClient speechClient = SpeechClient.create()) {
      ...
      RecognitionMetadata.InteractionType interactionType =
          RecognitionMetadata.InteractionType.DISCUSSION;
      RecognitionMetadata.MicrophoneDistance microphoneDistance =
          RecognitionMetadata.MicrophoneDistance.NEARFIELD;
      RecognitionMetadata.RecordingDeviceType recordingDeviceType =
          RecognitionMetadata.RecordingDeviceType.SMARTPHONE;
      String recordingDeviceName = "Pixel 2 XL";
      int industryNaicsCodeOfAudio = 519190;
      RecognitionMetadata metadata =
          RecognitionMetadata.newBuilder()
              .setInteractionType(interactionType)
              .setMicrophoneDistance(microphoneDistance)
              .setRecordingDeviceType(recordingDeviceType)
              .setRecordingDeviceName(recordingDeviceName)
              .setIndustryNaicsCodeOfAudio(industryNaicsCodeOfAudio)
              .build();
