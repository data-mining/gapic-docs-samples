...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])
...
_JOB = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='company_name', full_name='google.cloud.talent.v4beta1.Job.company_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_JOB_DERIVEDINFO.fields_by_name['locations'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._LOCATION
_JOB_DERIVEDINFO.fields_by_name['job_categories'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._JOBCATEGORY
_JOB_DERIVEDINFO.containing_type = _JOB
_JOB_PROCESSINGOPTIONS.fields_by_name['html_sanitization'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._HTMLSANITIZATION
_JOB_PROCESSINGOPTIONS.containing_type = _JOB
_JOB_CUSTOMATTRIBUTESENTRY.fields_by_name['value'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._CUSTOMATTRIBUTE
_JOB_CUSTOMATTRIBUTESENTRY.containing_type = _JOB
_JOB.fields_by_name['application_info'].message_type = _JOB_APPLICATIONINFO
_JOB.fields_by_name['job_benefits'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._JOBBENEFIT
_JOB.fields_by_name['compensation_info'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._COMPENSATIONINFO
_JOB.fields_by_name['custom_attributes'].message_type = _JOB_CUSTOMATTRIBUTESENTRY
_JOB.fields_by_name['degree_types'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._DEGREETYPE
_JOB.fields_by_name['employment_types'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._EMPLOYMENTTYPE
_JOB.fields_by_name['job_level'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._JOBLEVEL
_JOB.fields_by_name['posting_region'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._POSTINGREGION
_JOB.fields_by_name['visibility'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._VISIBILITY
...
Job = _reflection.GeneratedProtocolMessageType('Job', (_message.Message,), dict(
  ...
  ProcessingOptions = _reflection.GeneratedProtocolMessageType('ProcessingOptions', (_message.Message,), dict(
  ...
  Attributes:
      name:
          ...
          example, "projects/api-test-project/jobs/1234".  Use of this
          field in job queries and API calls is preferred over the use
          of [requisition\_id][google.cloud.talent.v4beta1.Job.requisiti
          on\_id] since this value is unique.
      company_name:
      ...
      posting_expire_time:
          ...
          same [company][google.cloud.talent.v4beta1.Job.name][], [langu
          age\_code][google.cloud.talent.v4beta1.Job.language\_code] and
          [requisition\_id][google.cloud.talent.v4beta1.Job.requisition\
          _id].  The expired jobs are retained in our system for 90
          days. However, the overall expired job count cannot exceed 3
          times the maximum of open jobs count over the past week,
          otherwise jobs with earlier expire time are cleaned first.
          Expired jobs are no longer accessible after they are cleaned
          out.  Invalid timestamps are ignored, and treated as expire
          time not provided.  Timestamp before the instant request is
          ...
          masks include [expiry\_time][], or the masks are empty meaning
          that every field is updated, the job posting expires after 30
          days from the job's last update time. Otherwise the expiration
          date isn't updated.
      posting_create_time:
