...
use Google\Cloud\Dialogflow\V2beta1\DetectIntentRequest;
use Google\Cloud\Dialogflow\V2beta1\DetectIntentResponse;
use Google\Cloud\Dialogflow\V2beta1\OutputAudioConfig;
use Google\Cloud\Dialogflow\V2beta1\QueryInput;
use Google\Cloud\Dialogflow\V2beta1\QueryParameters;
use Google\Cloud\Dialogflow\V2beta1\StreamingDetectIntentRequest;
use Google\Cloud\Dialogflow\V2beta1\StreamingDetectIntentResponse;
...
class SessionsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.v2beta1.Sessions';
