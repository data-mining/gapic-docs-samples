...
class ProfileServiceClient(object):
    ...
    @classmethod
    def profile_path(cls, project, company, profile):
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=profile_service_grpc_transport.
    ...
    def list_profiles(self,
        ...
        if 'list_profiles' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_profiles'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_profiles,
                    default_retry=self._method_configs['ListProfiles'].retry,
                    default_timeout=self._method_configs['ListProfiles'].
                    timeout,
    ...
    def create_profile(self,
        ...
        if 'create_profile' not in self._inner_api_calls:
            self._inner_api_calls[
                'create_profile'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.create_profile,
                    default_retry=self._method_configs['CreateProfile'].retry,
                    default_timeout=self._method_configs['CreateProfile'].
                    timeout,
                    client_info=self._client_info,
                )
    ...
    def get_profile(self,
        ...
        Example:
            ...
            >>> client = talent_v4beta1.ProfileServiceClient()
            >>>
            >>> name = client.profile_path('[PROJECT]', '[COMPANY]', '[PROFILE]')
            >>>
        ...
        Args:
            name (str): Required.
                ...
                The format is
                "projects/{project\_id}/companies/{company\_id}/profiles/{profile\_id}",
        ...
        if 'get_profile' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_profile'] = google.api_core.gapic_v1.method.wrap_method(
    ...
    def delete_profile(self,
        ...
        if 'delete_profile' not in self._inner_api_calls:
            self._inner_api_calls[
                'delete_profile'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.delete_profile,
                    default_retry=self._method_configs['DeleteProfile'].retry,
                    default_timeout=self._method_configs['DeleteProfile'].
                    timeout,
                    client_info=self._client_info,
                )
    ...
    def search_profiles(self,
        ...
        if 'search_profiles' not in self._inner_api_calls:
            self._inner_api_calls[
                'search_profiles'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.search_profiles,
                    default_retry=self._method_configs['SearchProfiles'].retry,
                    default_timeout=self._method_configs['SearchProfiles'].
                    timeout,
                    client_info=self._client_info,
                )
