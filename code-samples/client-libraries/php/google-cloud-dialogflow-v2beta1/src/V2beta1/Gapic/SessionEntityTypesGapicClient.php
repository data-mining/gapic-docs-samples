...
use Google\Cloud\Dialogflow\V2beta1\CreateSessionEntityTypeRequest;
use Google\Cloud\Dialogflow\V2beta1\DeleteSessionEntityTypeRequest;
use Google\Cloud\Dialogflow\V2beta1\GetSessionEntityTypeRequest;
use Google\Cloud\Dialogflow\V2beta1\ListSessionEntityTypesRequest;
use Google\Cloud\Dialogflow\V2beta1\ListSessionEntityTypesResponse;
use Google\Cloud\Dialogflow\V2beta1\SessionEntityType;
use Google\Cloud\Dialogflow\V2beta1\UpdateSessionEntityTypeRequest;
...
class SessionEntityTypesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.v2beta1.SessionEntityTypes';
    ...
    private static $environmentSessionNameTemplate;
    private static $sessionEntityTypeNameTemplate;
    private static $environmentSessionEntityTypeNameTemplate;
    ...
    private static function getEnvironmentSessionNameTemplate()
    {
        if (null == self::$environmentSessionNameTemplate) {
            self::$environmentSessionNameTemplate = new PathTemplate('projects/{project}/agent/environments/{environment}/users/{user}/sessions/{session}');
        }

        return self::$environmentSessionNameTemplate;
    }
    ...
    private static function getEnvironmentSessionEntityTypeNameTemplate()
    {
        if (null == self::$environmentSessionEntityTypeNameTemplate) {
            self::$environmentSessionEntityTypeNameTemplate = new PathTemplate('projects/{project}/agent/environments/{environment}/users/{user}/sessions/{session}/entityTypes/{entity_type}');
        }

        return self::$environmentSessionEntityTypeNameTemplate;
    }
    ...
    private static function getPathTemplateMap()
    {
        if (null == self::$pathTemplateMap) {
            self::$pathTemplateMap = [
                ...
                'environmentSession' => self::getEnvironmentSessionNameTemplate(),
                'sessionEntityType' => self::getSessionEntityTypeNameTemplate(),
                'environmentSessionEntityType' => self::getEnvironmentSessionEntityTypeNameTemplate(),
            ];
        }
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a environment_session resource.
     *
     * @param string $project
     ...
     * @param string $session
     *
     * @return string The formatted environment_session resource.
     * @experimental
     */
    public static function environmentSessionName($project, $environment, $user, $session)
    {
        return self::getEnvironmentSessionNameTemplate()->render([
            'project' => $project,
    ...
    /**
     * Formats a string containing the fully-qualified path to represent
     * a environment_session_entity_type resource.
     *
     * @param string $project
     * @param string $environment
     * @param string $user
     ...
     * @param string $entityType
     *
     * @return string The formatted environment_session_entity_type resource.
     * @experimental
     */
    public static function environmentSessionEntityTypeName($project, $environment, $user, $session, $entityType)
    {
        return self::getEnvironmentSessionEntityTypeNameTemplate()->render([
            'project' => $project,
            'environment' => $environment,
            'user' => $user,
            'session' => $session,
     ...
     * - environmentSession: projects/{project}/agent/environments/{environment}/users/{user}/sessions/{session}
     * - sessionEntityType: projects/{project}/agent/sessions/{session}/entityTypes/{entity_type}
     * - environmentSessionEntityType: projects/{project}/agent/environments/{environment}/users/{user}/sessions/{session}/entityTypes/{entity_type}.
     *
