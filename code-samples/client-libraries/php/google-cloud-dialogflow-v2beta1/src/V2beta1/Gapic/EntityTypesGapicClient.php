...
use Google\Cloud\Dialogflow\V2beta1\BatchCreateEntitiesRequest;
use Google\Cloud\Dialogflow\V2beta1\BatchDeleteEntitiesRequest;
use Google\Cloud\Dialogflow\V2beta1\BatchDeleteEntityTypesRequest;
use Google\Cloud\Dialogflow\V2beta1\BatchUpdateEntitiesRequest;
use Google\Cloud\Dialogflow\V2beta1\BatchUpdateEntityTypesRequest;
use Google\Cloud\Dialogflow\V2beta1\BatchUpdateEntityTypesResponse;
use Google\Cloud\Dialogflow\V2beta1\CreateEntityTypeRequest;
use Google\Cloud\Dialogflow\V2beta1\DeleteEntityTypeRequest;
use Google\Cloud\Dialogflow\V2beta1\EntityType;
use Google\Cloud\Dialogflow\V2beta1\EntityTypeBatch;
use Google\Cloud\Dialogflow\V2beta1\EntityType_Entity;
use Google\Cloud\Dialogflow\V2beta1\GetEntityTypeRequest;
use Google\Cloud\Dialogflow\V2beta1\ListEntityTypesRequest;
use Google\Cloud\Dialogflow\V2beta1\ListEntityTypesResponse;
use Google\Cloud\Dialogflow\V2beta1\UpdateEntityTypeRequest;
...
class EntityTypesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dialogflow.v2beta1.EntityTypes';
